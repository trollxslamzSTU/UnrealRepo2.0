...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics
	{
		struct _Script_C4EGameProject_eventRegisterCollectableSignature_Parms
		{
			ACollectable* collectable;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_collectable;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::NewProp_collectable = { "collectable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_C4EGameProject_eventRegisterCollectableSignature_Parms, collectable), Z_Construct_UClass_ACollectable_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::NewProp_collectable,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "GameRule_Collectables.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_C4EGameProject, nullptr, "RegisterCollectableSignature__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::_Script_C4EGameProject_eventRegisterCollectableSignature_Parms), Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_C4EGameProject_RegisterCollectableSignature__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FRegisterCollectableSignature_DelegateWrapper(const FScriptDelegate& RegisterCollectableSignature, ACollectable* collectable)
{
	struct _Script_C4EGameProject_eventRegisterCollectableSignature_Parms
	{
		ACollectable* collectable;
	};
	_Script_C4EGameProject_eventRegisterCollectableSignature_Parms Parms;
	Parms.collectable=collectable;
	RegisterCollectableSignature.ProcessDelegate<UObject>(&Parms);
}
	DEFINE_FUNCTION(UGameRule_Collectables::execHandle_RegisterCollectable)
	{
		P_GET_OBJECT(ACollectable,Z_Param_collectable);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Handle_RegisterCollectable(Z_Param_collectable);
		P_NATIVE_END;
	}
	...
	void UGameRule_Collectables::StaticRegisterNativesUGameRule_Collectables()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "Handle_RegisterCollectable", &UGameRule_Collectables::execHandle_RegisterCollectable },
		};
	...
	struct Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics
	{
		struct GameRule_Collectables_eventHandle_RegisterCollectable_Parms
		{
			ACollectable* collectable;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_collectable;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::NewProp_collectable = { "collectable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(GameRule_Collectables_eventHandle_RegisterCollectable_Parms, collectable), Z_Construct_UClass_ACollectable_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::NewProp_collectable,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "GameRule_Collectables.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameRule_Collectables, nullptr, "Handle_RegisterCollectable", nullptr, nullptr, sizeof(Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::GameRule_Collectables_eventHandle_RegisterCollectable_Parms), Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameRule_Collectables_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UGameRule_Collectables_Handle_RegisterCollectable, "Handle_RegisterCollectable" }, // 531349155
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_l021011n_STUDENT_004_Documents_GitHub_UnrealRepo2_0_C4EGameProject_Source_C4EGameProject_GameRule_Collectables_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_l021011n_STUDENT_004_Documents_GitHub_UnrealRepo2_0_C4EGameProject_Source_C4EGameProject_GameRule_Collectables_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameRule_Collectables, UGameRule_Collectables::StaticClass, TEXT("UGameRule_Collectables"), &Z_Registration_Info_UClass_UGameRule_Collectables, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameRule_Collectables), 715040421U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_l021011n_STUDENT_004_Documents_GitHub_UnrealRepo2_0_C4EGameProject_Source_C4EGameProject_GameRule_Collectables_h_684324628(TEXT("/Script/C4EGameProject"),
		Z_CompiledInDeferFile_FID_Users_l021011n_STUDENT_004_Documents_GitHub_UnrealRepo2_0_C4EGameProject_Source_C4EGameProject_GameRule_Collectables_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_l021011n_STUDENT_004_Documents_GitHub_UnrealRepo2_0_C4EGameProject_Source_C4EGameProject_GameRule_Collectables_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
